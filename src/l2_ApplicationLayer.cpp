...
bool Application::performCommand(const vector<string> & args)
{
    ...
    if (args[0] == "a" || args[0] == "add")
    {
        ...
        _col.addItem(make_shared<MusicCollection>(args[1].c_str(), args[2].c_str(), args[3].c_str(), args[4].c_str(), stoul(args[5])));
        return true;
    }
    ...
    if (args[0] == "u" || args[0] == "update")
    {
        ...
        _col.updateItem(stoul(args[1]), make_shared<MusicCollection>(args[2].c_str(), args[3].c_str(), args[4].c_str(), args[5].c_str(), stoul(args[6])));
        return true;
    }
    ...
    if (args[0] == "v" || args[0] == "view")
    {
        ...
        {
            const MusicCollection & item = static_cast<MusicCollection &>(*_col.getItem(i));
